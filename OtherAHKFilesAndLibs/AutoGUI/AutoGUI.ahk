...
ShowTabContextMenu() {
    ...
    If (FileExist(FileName)) {
        ...
        Menu TabContextMenu, Enable, Open in a New Window
        ...
        Menu TabContextMenu, Disable, Open in a New Window
...
SetTabIcon(n) {
    TabEx.SetIcon(n, (n == g_GuiTab) ? 3 : (Sci[n].FileName != "") ? 2 : 1)
}
